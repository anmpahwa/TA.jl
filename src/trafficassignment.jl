...
- `tol::Float=1e-5`         : Tolerance level for relative gap
- `maxiters::Int=20`        : Maximum number of iterations
- `maxruntime::Int=300`     : Maximum algorithm run time (seconds)
- `log::Symbol`             : Log iterations (one of `:off`, `:on`)
"""
assigntraffic(; method::Symbol, network::String, assignment=:UE, tol=1e-5, maxiters=20, maxruntime=300, log=:off) = getfield(TA, method)(build(network, assignment), tol, maxiters, maxruntime, log)